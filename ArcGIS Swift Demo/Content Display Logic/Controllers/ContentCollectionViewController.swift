...
class ContentCollectionViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, CustomSearchHeaderViewDelegate {
    ...
    func populateTree() {//321下面这几个方法干啥用的？
    ...
    func nodesByDisplayNames(_ names:[String]) -> [Node] { //321 不明白
        var nodes = [Node]()
    ...
    //get the size of the new view to be transitioned to //321transition了解一下
